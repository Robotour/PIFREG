# Vendored copy of pyelastix v1.2 (https://github.com/almarklein/pyelastix)
# Kept in-tree so we can extend it for global HSI registration experiments.
# Requires the external Elastix/transformix executables (set ELASTIX_PATH if needed).
