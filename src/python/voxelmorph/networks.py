"""Official VoxelMorph PyTorch networks (VxmDense + U-Net)."""
...
class ConvBlock(nn.Module):
    """Convolution block followed by LeakyReLU for U-Net."""
...
class VxmDense(LoadableModel):
    """Official VoxelMorph dense (deformable) registration network."""
