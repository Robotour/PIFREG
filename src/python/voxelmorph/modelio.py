"""Model save/load utilities (official VoxelMorph torch modelio)."""
...
def store_config_args(func):
    """Save constructor arguments to self.config for LoadableModel."""
...
class LoadableModel(nn.Module):
    """Base class for VoxelMorph models with config-based loading."""
